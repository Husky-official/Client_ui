...
public class HiringPage extends JFrame {
    ...
    public void initUI() {
        ...
        jobPosting.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                for(Frame fr : frames){
                    ...
                    if(!specificFrameName.equals("src.pages.hiring.JobApplicationPage")){
        ...
        jobApplication.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                JobApplicationPage applicationPage = new JobApplicationPage();
                applicationPage.setVisible(true);
                Frame[] frames = Frame.getFrames();
                for(Frame fr : frames){
                    String specificFrameName = fr.getClass().getName();
                    if(!specificFrameName.equals("src.pages.hiring.JobPostingPage")){
                        if(fr.getSize().width > 600){
                           applicationPage.setExtendedState(JFrame.MAXIMIZED_BOTH);
                        }
                        fr.dispose();
                    }
                }
