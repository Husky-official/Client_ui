...
public class NavBar extends JFrame{
    ...
    public void initUI() {
        ...
        ImageIcon recentIcon = new ImageIcon(Objects.requireNonNull(getClass().getResource("/src/img/nav_recent.png")));
        this.recent = new JLabel(recentIcon);
        this.recent.setToolTipText("Recent Activities");
        ImageIcon notificationsIcon = new ImageIcon(Objects.requireNonNull(getClass().getResource("/src/img/nav_notifications.png")));
        this.notifications = new JLabel(notificationsIcon);
        this.notifications.setToolTipText("Notifications");
        ImageIcon settingsIcon = new ImageIcon(Objects.requireNonNull(getClass().getResource("/src/img/nav_settings.png")));
        this.settings = new JLabel(settingsIcon);
        this.settings.setToolTipText("Settings");
        ImageIcon logoutIcon = new ImageIcon(Objects.requireNonNull(getClass().getResource("/src/img/nav_logout.png")));
        this.logout = new JLabel(logoutIcon);
        this.logout.setToolTipText("Logout");
        ImageIcon avatarIcon = new ImageIcon(Objects.requireNonNull(getClass().getResource("/src/img/nav_avatar.png")));
